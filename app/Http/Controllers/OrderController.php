...
class OrderController extends Controller
{
    ...
    public function productTrackOrder(Request $request){
        ...
        if(auth()->check()) {
            ...
            // Rechercher la commande associée à l'utilisateur actuel et au numéro de commande fourni
            ...
            if($order) {
                // Gérer les différents états de la commande
                if($order->status == "new") {
                ...
                // Si aucune commande correspondante n'est trouvée, afficher un message d'erreur
                request()->session()->flash('error', 'Invalid order number. Please try again!');
                return redirect()->back();
            }
        } else {
            // Si l'utilisateur n'est pas authentifié, rediriger vers la page précédente avec un message d'erreur
            request()->session()->flash('error', 'You must be logged in to track your order.');
            return redirect()->back();
        }
    }
    // PDF generate
